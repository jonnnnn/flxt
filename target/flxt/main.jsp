            ...
            <div id="menu-box">
                <ul class="kit-menu">
                    ...
                    <li class="kit-menu-item" id="spjczl" hidden>
                        ...
                        <li class="kit-menu-item" id="qrlrAdd" hidden>
                            <a href="#/lz/qrlrAdd">
                                <i class="layui-icon">&#xe62e;</i>
                                <span>政策补充</span>
                            </a>
                        </li>
                        <li class="kit-menu-item" id="qrlraddSh" hidden>
                            <a href="#/lz/qrlraddSh">
                                <i class="layui-icon">&#xe62e;</i>
                                <span>补充政策审核</span>
                            </a>
                        ...
                        <li class="kit-menu-item" id="qrlraddQuery" hidden>
                            <a href="#/lz/qrlraddQuery">
                                <i class="layui-icon">&#xe62e;</i>
                                <span>补充政策查询</span>
                            </a>
                        </li>
                        <li class="kit-menu-item" id="ssmxcx" hidden>
                            <a href="#/lz/queryssmx">
                                <i class="layui-icon">&#xe62e;</i>
                                <span>历史实收查询</span>
                            </a>
