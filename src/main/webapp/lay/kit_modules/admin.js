        ...
        routeInit: function (e) {
            var t = this, a = {
                ...
                routes: [{
                    ...
                    {path: "/lz/yxs", component: "views/lz/yxs.html", name: "预销售"},
                    {path: "/lz/xsqr", component: "views/lz/xsqr.html", name: "销售确认"},
                    ...
                    {path: "/lz/yxsquery", component: "views/lz/yxsquery.html", name: "预销售查询"},
                    {path: "/lz/xsqrquery", component: "views/lz/xsqrquery.html", name: "销售确认查询"},
                    {path: "/lz/custapi", component: "views/lz/custapi.html", name: "客户资料调用"},
                    {path: "/lz/formbox", component: "views/lz/formbox.jsp", name: "表单盒子"}
