        ...
        routeInit: function (e) {
            var t = this, a = {
                ...
                routes: [{
                    ...
                    {path: "/lz/queryssmx", component: "views/lz/QuerySsmx.html", name: "实收明细查询"},
                    {path: "/lz/qrlrAdd", component: "views/lz/qrlrAdd.html", name: "政策补充"},
                    {path: "/lz/qrlraddSh", component: "views/lz/qrlraddSh.html", name: "补充政策审核"},
                    {path: "/lz/qrlraddQuery", component: "views/lz/qrlraddQuery.html", name: "补充政策查询"}
                ]
            };
